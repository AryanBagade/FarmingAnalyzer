...
dashboardPage(skin = "#e50808",
	dashboardHeader(
						title = "Decentralised Farming and supply chain",
						titleWidth = 700,
						tags$li(a(
									href = 'https://www.aryanb.tech',
									target="_blank",
									img(src = 'LeoAgriculture.png',title = "AryanB.tech", height = "45px"),
